...
{
    /// <summary>
    /// Defines a list of states
    /// Partly taken from StackExchange at (https://stackoverflow.com/questions/7367529/standardized-us-states-array-and-countries-array)
    /// </summary>
    public static class StateList
    {
        public static List<State> list { get; }

        /// <summary>
        /// Constructs the StateList
        /// </summary>
        static StateList()
        {
            // United States
